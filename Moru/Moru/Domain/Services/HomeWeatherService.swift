...
@MainActor
final class CoreLocationWeatherService: NSObject, HomeWeatherService, CLLocationManagerDelegate {
  ...
  func weatherSnapshot(for location: CLLocation) async throws -> HomeWeatherSnapshot {
    ...
    do {
      ...
      guard let latitudeE4 = roundedE4(location.coordinate.latitude),
