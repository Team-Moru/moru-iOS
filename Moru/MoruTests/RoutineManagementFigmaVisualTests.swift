...
private enum RoutineManagementVisualBaseline {
  static let hashes: [String: String] = [
    ...
    "delete-dialog-light-M.png":
      "gACAAMBAggaCBpBAgALEAoAC5CKgAsAAyACAFgyHHoeGhwaHEGcYZ5AP0Qy4BtANogLQBdANuAL4DMDE4MjAAA==",
    ...
    "editor-long-korean-light-M.png":
      "AAAAACBBkgaCBpBAgIFUWRAD6sNQAsgAyIKTBJMEyADIMHEHUQ04ElANUCUjAw8DICNAAAAAAAPhAMDEwMBgAA==",
    ...
    "editor-schedule-light-M.png":
      "AAAAACBBkgaCBpBAgAHEAxADZiNSAsgAwQKuBIIkBNDEwMTAxMAk0BEq1VTVVMgRyABwD1ANMALxAMDExMBAAA==",
    "list-empty-light-AX3.png":
      "AAAAACgAxADEAOUAGkAGgAYABoA7IDM4MKQ5olUYXZB7sPqYhRYexxrHgD7gAAAAAAAAAAAAAACSImzIZMgAIA==",
    "list-empty-light-M.png":
      "AAAAACAAwADAACAAAAAAgAMAAzANSByAmOAGlwaDwEAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAACRImzIbMkgSA==",
    "list-error-light-AX3.png":
      "AAAAACgAxADEAOSAGwADAAaQAxAZIBmkYsBo2RlECUAawNhggr4bBxtHhL7wAAAAAAAAAAAAAACSImzIZMgAIA==",
    "list-error-light-M.png":
      "AAAAACAAwADAACAAAAAAgAMAAxgeZB4AhNAHEwcDwMAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAACRImzIbMkgSA==",
