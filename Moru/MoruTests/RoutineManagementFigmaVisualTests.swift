...
private enum RoutineManagementVisualBaseline {
  static let hashes: [String: String] = [
    "create-empty-light-AX3.png":
      "AAAAAAYAxpCGgIAAyADMAFEDUQMqA0yDaIMhAdAA2QD5QKVk82TwkiaE2XjReCUOPqM8oyVL4ADAwMDAwgDgAA==",
    "create-empty-light-M.png":
      "AAAAAAAAxxDDAIAAkABAA0gDZANAA8AAyQCKBIgEAQLIAIAgDwMPA4AgAAAAAAAAAAAAAAAAAADAAMCAwADAAA==",
    "creation-choice-light-AX3.png":
      "gACAAIKSxpSCmoAMyABDMwyBDIAAEA2AHIAcAB4gTODMpsyGDcAMAA4ADwANAB2AHIAcAM4GzuZNwAzASpD6gA==",
    "creation-choice-light-M.png":
      "gACAAIIKwhSCGoAMkADAAsCC4gLiAoCAwQDIBIwEgQLIALkC0AwARwMBAwAcANoG2oYdQAAA2QDKBshAIACgAA==",
    "delete-dialog-light-AX3.png":
      "gACAAIKSxpSCmoAMyADCAOgAyIYABxtHD+ccAx5nHqecp7nHmJeGB44HACePB4cHgKYxB/MB9SDExMDE8gCwAA==",
    "delete-dialog-light-M.png":
      "gACAAIIKwhSCGoAMkADAAsCC4gLiAoCAyACAFoyHHoeGhwaHEGcYZ5Ae0A24AtAN0ga4BtANkALpAMDEwMDgAA==",
    "editor-collapsed-light-AX3.png":
      "AAAAAAIQxpSCmoAIyADCAEiDyIMUI/VDdUNzI0kDJkDZANmQpWDhZPKUIoLZWdlJJqMxB3MB+zDExMTE8gD0AA==",
    "editor-collapsed-light-M.png":
      "AAAAAAAKwhXDGoAMmABAA8DDZSNiI4CAyQCKBIgEAQLIADgDUA0CB1AHUA0sAlANUgc4B1ANEgP5AMDEwMhgAA==",
    "editor-long-korean-light-AX3.png":
      "AAAAAAIQxpSCmoAIyADIinZ0dyTNJ2k3aIsHD8yz6JPG52RnZGcGmNkA2SClkuUUk5SThnRh8wDExMTE8yAxgA==",
    ...
    "editor-schedule-light-AX3.png":
      "AAAAAAIQxpSCmoAIyADCAEiDyIMUI/VDdUNzI0kDJkDZANmQpWDhZPjMTMgFEJEwzMjMzHEx8yDExMTE9QBkQA==",
    "editor-schedule-light-M.png":
      "AAAAAAAKwhXDGoAMmABAA8DDZSNiI4CAyQCKBIgEBMIE0MTAxMAEwATK1VTVVFVAyCCoAlANEA/lAMDMwMB4AA==",
    ...
    "step-add-light-AX3.png":
      "gACAAIKSxpSCmoAMyABBAwUBDoAMgAAQwADQAFwg1IKgAOAE4VjSuMK00ELAAMAA4yDDLNMg4EDAxMDA4ADwAA==",
    "step-add-light-M.png":
      "gACAAIIKwhSCGoAMkADAAsCC4gLiAoiAyAMDAwIAAADAAMAAwALQhOMY4RjhGJAEgADDBMMEwIDAhMAEwADgAA==",
    "step-edit-light-AX3.png":
      "gACAAIKSxpSCmoAMyABBAwRBDsAMwAAQwADQAHig+ILRkOBE4VjSuMK00ELAAMAA4yDDJPMA8gDEzMDE8gBwAA==",
    "step-edit-light-M.png":
      "gACAAIIKwhSCGoAMkADAAsCC5CJjAwMBAgAAAMAAwADoAtCE4xjhGOMYkACAgMMkwwTgwMDEwEADAoMiwMDQAA==",
    "weekday-conflict-light-AX3.png":
      "gACAAIKSxpTCmIBOgAedJx1nDAcNhx1nGUcxUzlTKXO2Y5ZjhoebR5tHHKeUp4IHAwcAJw0HjgbAzMDE8gCwAA==",
    "weekday-conflict-light-M.png":
      "gACAAIIKwhSCGoAMkADAAsCC4gLiAogAyASANg5HHwe9IzrjBgcYZ5Bn0A24AtAN0ga4BtANkALpAMDE5MjgAA==",
  ]
}
